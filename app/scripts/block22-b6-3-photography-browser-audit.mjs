...
/**
 * Bloque 22 — B6.3: muestreo en navegador de las fotografías identity nuevas de grado A,
 * contra el build de producción (`vite preview`).
 *
 * B6.3 no toca UI: las fotografías tienen que aparecer solas por el contrato existente. Este gate
...
const SAMPLES = [
  ...
  { id: "JP-140", hub: "Osaka" },
  { id: "JP-150", hub: "Osaka" },
  { id: "JP-166", hub: "Okinawa" },
  { id: "JP-199", hub: "Okinawa" },
  { id: "JP-209", hub: "Osaka" },
];
const FALLBACK_SAMPLE = { id: "JP-107", hub: "Osaka" };
const VIEWPORTS = {
...
console.log("B6.3 grade-B photography browser audit — production build via vite preview");
...
console.log(`\n${"═".repeat(60)}\nB6.3 photography audit: ${passed} passed, ${failed} failed\n`);
