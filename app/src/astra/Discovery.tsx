...
export function Discovery({ places, hubs, state, savedIds, onToggle, onState, onOpen, onRegions }: Props) {
  ...
  return <>
    <section className="astra-intro"><p className="astra-eyebrow">JAPÓN, A SU MANERA</p><h1>{hub ? `Descubre ${hub}` : <>¿Qué te gustaría vivir en Japón?<span className="visually-hidden"> ¿Qué les gustaría descubrir?</span></>}</h1><p>Marca lo que te gusta. El viaje lo armamos después.</p></section>
