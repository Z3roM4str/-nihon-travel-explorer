...
type Props = { places: Place[]; hubs: string[]; state: ExploreState; savedIds: string[]; onToggle: (id: string) => void; onState: (state: ExploreState, replace?: boolean) => void; onOpen: (id: string) => void };
